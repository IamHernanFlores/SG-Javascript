...
function gameOver() {
  ...
  dibujarTexto(CTX, " ¡Pulsa una tecla para empezar!", 300, 360);
...
dibujarParedes(CTX);
dibujarTexto(CTX, "¡Pulsa una tecla para empezar!", 300, 160), "300px Arial";
dibujarTexto(CTX, "PC: Muévete con ↑ ↓ → ←", 300, 300);
dibujarTexto(CTX, "Móbil: Tap para girar la serpiente", 300, 360);
dibujarTexto(CTX, "by Hernán Flores", 300, 500);
